...
{
    public class GenerateAndConsumeAsynchronousStreams
    {
...
";
        ...
        #region Enumarate Old Style
        #region <SnippetRunPagedQuery>
        ...
        #region Enumarate New Stype With IEnumarateAsynchronous Streams
        #region <SnippetRunPagedQuery>
        ...
        #region Main
        public static async Task MainGenerateAndConsumeAsynchronousStreams()
        {
            ...
            "get Github Access token like instructions above");
            ...
            #region <SnippetEnumerateOldStyle>
            ...
            #region <SnippetEnumerateNEWStyleUSINGIENUMARATOR>
            int num = 0;
