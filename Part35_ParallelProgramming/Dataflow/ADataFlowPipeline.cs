...
namespace Part35_ParallelProgramming.Dataflow
{
    ...
    //reference: https://learn.microsoft.com/en-us/dotnet/standard/parallel-programming/walkthrough-creating-a-dataflow-pipeline
    public class ADataFlowPipeline
    {
        public static void MainADataFlowPipeline()
        {
            ...
            #region Begin and Complete pipeline
