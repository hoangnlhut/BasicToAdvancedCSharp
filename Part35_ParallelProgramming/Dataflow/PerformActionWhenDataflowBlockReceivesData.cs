...
{
    //reference: https://learn.microsoft.com/en-us/dotnet/standard/parallel-programming/how-to-perform-action-when-a-dataflow-block-receives-data
    // Demonstrates how to provide delegates to exectution dataflow blocks.
    public class PerformActionWhenDataflowBlockReceivesData
    {
        ...
        public static void MainPerformActionWhenDataflowBlockReceivesData()
        {
            ...
            var countBytes = new TransformBlock<string, int>(CountBytes);
