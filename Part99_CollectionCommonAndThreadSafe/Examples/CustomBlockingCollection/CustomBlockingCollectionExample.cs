...
namespace Part99_CollectionCommonAndThreadSafe.Examples.CustomBlockingCollection
{
    //reference: How to: Add Bounding and Blocking Functionality to a Collection
    // https://learn.microsoft.com/en-us/dotnet/standard/collections/thread-safe/how-to-add-bounding-and-blocking
    public class CustomBlockingCollectionExample
    {
        public static void MainCustomBlockingCollectionExample()
        {
            int priorityCount = 7;
